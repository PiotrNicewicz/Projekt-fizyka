...
barrier_bottom = HEIGHT/2 - BARRIER_WIDTH/2
barrier_top = HEIGHT/2 + BARRIER_WIDTH/2
...
goals = {
    "barrier_top": [middle_x - 80, barrier_top],
    "barrier_bottom": [middle_x - 80, barrier_bottom],
...
for step in range(STEPS):
    ...
    for agent in agents:
        if agent.pos[0] < middle_x - 90:
            if agent.pos[1] > middle_y:
                agent.goal = goals["barrier_top"]
            else:
                agent.goal = goals["barrier_bottom"]
        elif agent.pos[0] < middle_x - 20:
